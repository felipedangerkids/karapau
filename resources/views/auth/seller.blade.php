      ...
      <div class="authentication-register-seller screen">
            ...
            <form action="{{ route('seller.register') }}" method="POST">
                  ...
                  <div class="imput-100-C61RwL border-2px-cloud">
                        <input class="imput-100-i4774411253-ETfRnS poppins-normal-manatee-18px" name="name"
                              placeholder="Nome" type="text" required />
                  </div>
                  <div class="imput-100-VMr6Om border-2px-cloud">
                        <input class="imput-100-i4776011253-UppLul poppins-normal-manatee-18px" name="lastname"
                              placeholder="Sobrenome" type="text" required />
                  </div>
                  <div class="imput-100-mzXdH9 border-2px-cloud">
                        <input class="imput-100-i4776311253-hrdCAf poppins-normal-manatee-18px" name="email"
                              placeholder="E-mail" type="email" required />
                  </div>
                  <div class="imput-100-QxM5SU border-2px-cloud">
                        <input class="imput-100-i4776611253-cOFO29 poppins-normal-manatee-18px" name="password"
                              placeholder="Senha" type="password" required />
                  </div>
                  <div class="imput-100-2P4qUJ border-2px-cloud">
                        <input class="imput-100-i4776911253-O7pYL7 poppins-normal-manatee-18px" name="password-confirm"
                              placeholder="Confirmar senha" type="password" required />
                  </div>
                  <div class="imput-100-qr8e7q border-2px-cloud">
                        <input class="imput-100-i4777211253-qy5OlV poppins-normal-manatee-18px" name="telefone"
                              placeholder="Telemóvel" type="text" required />
                  </div>
                  <div class="imput-100-J1YQmd border-2px-cloud">
                        <input class="imput-100-i4777511253-aZO6Rj poppins-normal-manatee-18px" name="morada"
                  ...
                  <div class="flex-row-C61RwL">
                        <div class="imput-50-dXBp89">
                              <div class="imput-50-xQrLAp">
                                    ...
                                    <input class="imput-50-i4786711255-oyqzX8 poppins-normal-manatee-18px" name="nif"
                        ...
                        <div class="imput-50-Xi618D">
                              <div class="imput-50-AqYWVV">
                                    ...
                                    <input class="imput-50-i4787111255-UnbuJE poppins-normal-manatee-18px" name="iban"
                  ...
                  <div class="imput-dropdown-100-C61RwL">
                        <div class="imput-dropdown-100-PF8xVf">
                              ...
                              <input class="imput-dropdown-100-i4787511327-xcwlBC poppins-normal-manatee-18px"
                                    name="porto" placeholder="Porto de registo" type="text" required />
                  ...
                  <div class="imput-100-a5WPlX border-2px-cloud">
                        <input class="imput-100-i4788111253-gxxi7y poppins-normal-manatee-18px" name="fishing_zone"
                              placeholder="Zona de Pesca" type="text" required />
                  </div>
                  <div class="btn-generic-C61RwL ">
                        <button type="submit" class="text-btn-generic-i47740226-Sts0rK">Registar</button>
                  </div>
            </form>
            <div class="flex-row-VMr6Om">
                  <input class="type-checkbox-BdpSxK border-2px-cloud" placeholder="type-checkbox" type="checkbox"
                        required />
